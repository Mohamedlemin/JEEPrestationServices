                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30" >Demandes</h3>
                            ...
                            <div class="QA_section ">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                        <c:forEach items="${demandes}" var="p">
                                            <tr>
                                                
                                                <td><span class="f_s_14 f_w_400 color_text_2" >${p.description}</span></td>
                                                <td class="f_s_14 f_w_400 color_text_3"> ${p.delais}  </td>
                                               <td><a href="#" class="status_btn">Accepter</a></td>
                                                <td>
                                                    
                                                       <a  href="ajoutProjet.php?id=${p.id}" class="badge_active2"><i class="fa fa-check"></i>  Accepter</a>
                                                        <a  class="badge_active3"> <i class="fa fa-times"></i> Refuser</a>
                                               </td>
                                            </tr>
                                         </c:forEach>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="comment" rows="1" disabled></textarea>
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group">
                                    <label>Delais</label>
                                    <input  type="text" class="form-control" placeholder="delais">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Budget Total</label>
                                    <input  type="number" class="form-control" placeholder="budget total">
                                </div>
                            </div>
                            <div class="col-md-6 pr-0">
                                <div class="form-group">
                                    <label >Chef Projet</label>
                                    <select class="form-control form-control" id="largeSelect" name="chefprojet">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  type="number" class="form-control" placeholder="budget projet">
                                </div>
                            </div>
                        </div>
