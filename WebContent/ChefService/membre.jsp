                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30" >Les Employers</h3>
                                ...
                                <div class="white_box_tittle list_header">
                                    ...
                                    <div class="box_right d-flex lms_block">
                                        <div class="serach_field_2">
                                            <div class="search_inner">
                                                <form    action="chercherMembre.php" method="get" Active="#">
                                                    <div class="search_field">
                                                        <input type="text" placeholder="Chercher..." value="${mot}" name="mot">
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        <a  href="modifierMembre.php?id=${p.id}" class="action_btn mr_10"> <i class="ti-pencil"></i> </a>
                                                        <a  onclick="return confirm('etes vous sure de sepprimer?')"  href="supprimerMembre.php?id=${p.id}"  class="action_btn"> <i class="ti-trash"></i> </a>
                                                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="saveMembre.php">
                        <div class="row">
                            <div class="col-sm-12">
