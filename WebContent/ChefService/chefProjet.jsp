                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30" >Les Chef Projets</h3>
                         
                        </div>
                        <div class="page_title_right">
                            <div class="page_date_button d-flex align-items-center"> 
                                <img src="ChefService/img/icon/calender_icon.svg" alt="">
                        ...
                        <div class="white_card_body">
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    <h4>Liste Chef Projet</h4>
                                    <div class="box_right d-flex lms_block">
                                        <div class="serach_field_2">
                                            <div class="search_inner">
                                                <form  action="chercherChef.php" method="get" Active="#">
                                                    <div class="search_field">
                                                        <input type="text" placeholder="Chercher..."  name="mot" value="${mot}">
                                                    </div>
                                        ...
                                        <div class="add_button ml-10">
                                            <button  data-toggle="modal" data-target="#addRowModal" class="btn_1"><i class="ti-plus"></i>Ajouter</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active3 ">
                                        <thead>
                                            <tr>
                                                <th scope="col"><i class="ti-user"></i></th>
                                                <th scope="col">Nom</th>
                                        ...
                                        <tbody>
                                          <c:forEach items="${chefprojets}" var="p">
                                            <tr>
                                                <th scope="row"> <a href="#" class="question_content"><i class="ti-user"></i></a></th>
                                                <td>  <span class="f_s_12 f_w_700 text_color_9" >${p.nom}</span></td>
                                                <td> <span class="f_s_12 f_w_700 text_color_11" >${p.prenom}</span></td>
                                                <td>  <span class="f_s_12 f_w_700 text_color_10" >${p.username}</span></td>
                                                <td> <span class="f_s_12 f_w_700 color_text_3" >${p.tel}</span></td>
                                              
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        <a  href="modifierChefProjet.php?id=${p.id}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                        <a onclick="return confirm('etes vous sure de sepprimer?')"  href="supprimerChef.php?id=${p.id}" class="action_btn"> <i class="fas fa-trash"></i> </a>
                                                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="saveChef.php">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Telephone</label>
                                    <input  type="number" class="form-control" placeholder="entrer numero" name="tel">
                                      <input  type="hidden" class="form-control"  name="serv" value="${service.id}">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group">
                                 <label>Username</label>
                                    <input  type="text" class="form-control" placeholder="entrer username" name="user">
