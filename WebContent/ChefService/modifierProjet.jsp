                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30" >Projets</h3>
                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Modifier Projet </h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body">
                         <form action="updateProjet.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="common_input mb_15">
                                     <label >Budget Total</label>
                                        <input type="number" placeholder="budget Total" name="budgetTotal" value="${projet.budgetTotal}">
                                 ...
                                 <div class="col-lg-6">
                                    <div class="common_input mb_15">
                                      <label >Budget</label>
                                        <input type="number" placeholder="Budget" name="budget" value="${projet.budget}">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-lg-6">
                                    <div class="common_input mb_15">
                                      <label >Dealais</label>
                                        <input type="text" placeholder="delais" name="delais" value="${projet.delais}">
                                    </div>
                                </div>
