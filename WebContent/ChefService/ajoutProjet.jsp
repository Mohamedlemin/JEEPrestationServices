                    ...
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            ...
                            <ol class="breadcrumb page_bradcam mb-0">
                                ...
                                <li class="breadcrumb-item active">Ajout Projet</li>
                            </ol>
                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Ajouter Projet </h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body">
                         <form action="SaveProjet.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="common_input mb_15">
                                     <label >Description</label>
                                        <input type="text" value="${demande.description}" name="desc">
                                         <input type="hidden" value="${demande.client}" name="client">
                                          <input type="hidden" value="${demande.getService()}" name="serv">
                                    </div>
                                </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="common_input mb_15">
                                     <label >Budget Total</label>
                                        <input type="number" placeholder="budget Total" name="budgetTotal">
                                    </div>
                                </div>
